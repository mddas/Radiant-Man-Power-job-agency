                ...
                <table class="table align-items-center mb-0">
                  <thead>
                    <tr>
                      ...
                      <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">Manager Name</th>
                    ...
                    <tr id="{{$contact['id']}}">
                      <td>
                        <div class="d-flex px-2 py-1">
                          <div>
                            <img src="/images/contact/{{$contact->manager_photo}}" class="avatar avatar-sm me-3" alt="xd">
                          </div>
                      ...
                      <td>
                            <span class="text-xs font-weight-bold">{{$contact->contents}}</span>
                          <!----
                      ...
                      <td>
                        <span class="text-xs font-weight-bold">{{$contact->manager_name}}</span>
                      </td>
                      <td class="align-middle text-center text-sm">
                          <div class="btn-group" style="position:static;">
                                ...
                                <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                    ...
                                    <li><button class="dropdown-item" onclick="deLete('{{$contact->id}}','/admin/delete-about')" >Delete</button></li>
