          ...
          <div class="col-md-4">
            <div class="product-item">
             <!--- assets/images/product-1-370x270.jpg--->
              <a href="/job-details?id={{$job->id}}"><img src="/images/job_image/{{$job->job_image}}" alt="" height=230px width=200px></a>
              <div class="down-content">
                <a href="/job-details?id={{$job->id}}"><h4>{{$job->name}}</h4></a>

                <h6>${{$job->salary}} Per month</h6>

                <h4><small><i class="fa fa-briefcase"></i><!---job category / subcategory---> {{substr($job->job_description, 0, 100)}} <br> <strong><i class="fa fa-building"></i> {{$job->company_name}}</strong></small></h4>
