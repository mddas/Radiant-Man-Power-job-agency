<!-- Page Content -->
@extends("layouts.master") @section("jobs")
<div
                    ...
                    <div class="col-md-6">
                        <div class="product-item">
                            ...
                            <div class="down-content">
                                <a href="job-details.html"
                                    ><h4>Lorem ipsum dolor sit amet</h4></a
                                >
                                ...
                                <h4>
                                    <small
                                        ><i class="fa fa-briefcase"></i> Medical
                                        / Health Jobs <br />
                                        <strong
                                            ><i class="fa fa-building"></i> BMI
                                            Kings Park Hospital</strong
                                        ></small
                                    >
                                </h4>
